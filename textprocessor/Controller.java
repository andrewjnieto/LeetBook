...
public class Controller {
	...
	/*
	 * The only purpose of main() is to call processFile with increasingingly larger
	 * and larger files. A larger file will give a more accurate sense of how fast
	 * addToTrends is, but at some point it may take so long to do the
	...
	public static void main(String[] args) {
		...
		/*
		 * These files are books from project Gutenberg. I have provided the inputs, as
		 * well as my outputs in the starter files
		 */

		/*
		 * NOTE: You may want to comment some of these out! Unless your program is very
		 * speedy on all operations some of these will never finish.
		 */
		rng = new Random(42);
...
//		processFile("7.txt");
	...
	public void processFile(ArrayList<String> list, File file) {
